        ...
        <motion.div
          ...
          <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center items-start text-white">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-4xl lg:text-5xl xl:text-6xl text-[#000000] font-bold leading-tight max-w-3xl mb-6 drop-shadow-lg">
            ...
            <motion.p
              ...
              className="text-lg md:text-xl font-medium max-w-2xl mb-10 text-black drop-shadow-md">
